...
export async function createSolicitacaoCompra(form) {
  ...
  Object.assign(payload, getSolicitacaoStatusDefaults(payload.status_geral))
...
export async function updateSolicitacaoCompra(id, updates) {
  ...
  if ('status_geral' in normalizedUpdates) {
    ...
    Object.assign(normalizedUpdates, getSolicitacaoStatusDefaults(normalizedUpdates.status_geral))
  }
