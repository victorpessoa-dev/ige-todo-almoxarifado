...
export async function updateSolicitacaoCompra(id, updates) {
  ...
  if ('fornecedor_nome' in normalizedUpdates) {
    normalizedUpdates.fornecedor_nome = normalizedUpdates.fornecedor_nome?.trim?.() || null
  }

  if ('fornecedor_contato' in normalizedUpdates) {
    normalizedUpdates.fornecedor_contato = normalizedUpdates.fornecedor_contato?.trim?.() || null
  }
