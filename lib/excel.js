  ...
  const worksheet = XLSX.utils.json_to_sheet(
    solicitacoes.map((solicitacao) => {
      ...
      return {
        ...
        'Centro de custo': solicitacao.centro_custo || '',
        ...
        'Previsao desejada': formatDate(solicitacao.previsao_desejada),
        'Previsao entrega': formatDate(solicitacao.previsao_entrega),
        'Data solicitacao': formatDate(solicitacao.data_solicitacao || solicitacao.created_at),
